...
import com.capgemini.capstore.services.CapStoreService;
       ...
       @CrossOrigin("http://localhost:5001/CapStoreSearch")
       @RestController
       @RequestMapping("/CapStoreSearch")
	   public class CapStoreController {
		...
		@GetMapping(value = "/findByCompanyName/{Company}")
		...
		@GetMapping(value="/findWithMerchantIdAndProductId/{merchantId}/{productId}")
